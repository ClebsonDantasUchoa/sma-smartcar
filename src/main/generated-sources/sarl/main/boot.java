...
public class boot extends Agent {
  ...
  protected AgentTask simulateUserDetected() {
    AgentTask _xblockexpression = null;
    {
      ...
      final AgentTask taskVar = _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER.task("simulate_events");
      ...
      final Procedure1<Agent> _function = (Agent it) -> {
        ...
        if ((numero == 0)) {
          ...
          UserDetected _userDetected = new UserDetected("rafael");
          _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER.emit(_userDetected);
        } else {
          if ((numero == 1)) {
            DefaultContextInteractions _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_1 = this.$castSkill(DefaultContextInteractions.class, (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS == null || this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS = this.$getSkill(DefaultContextInteractions.class)) : this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS);
            UserDetected _userDetected_1 = new UserDetected("marcos");
